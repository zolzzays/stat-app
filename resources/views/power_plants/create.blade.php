...
@section('title', 'Станц нэмэх')

@section('content')

<div class="d-flex justify-content-between align-items-center mb-3">
    <h4 class="mb-0 fw-bold">Шинээр станц бүртгэх</h4>
...
<div class="card">
    <div class="card-body">
        <form action="{{ route('power_plants.store') }}" method="POST">
            @csrf
                ...
                <div class="col-md-6">
                    ...
                    <select name="reg_type_id" class="form-select">
                        ...
                        @foreach($regTypes as $rt)
                            <option value="{{ $rt->id }}" {{ old('reg_type_id') == $rt->id ? 'selected' : '' }}>
                                {{ $rt->type_name }}
                            </option>
                        @endforeach
                    </select>
